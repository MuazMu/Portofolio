...
import {
  ...
  SiExpress, SiPostgresql, SiDocker, SiRedis, SiSupabase, SiLinux,
  SiNextdotjs, SiNestjs, SiMysql
} from 'react-icons/si';
...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      id: 4,
      title: 'Dablie Tech',
      description: 'Startup Innovation Platform designed to support entrepreneurs and innovators in building tech ventures.',
      icon: FaRocket,
    ...
    },
    {
      id: 5,
      title: 'Dablie',
      description: 'Enterprise platform connecting entrepreneurs, investors, and innovators to scale technology startups.',
      icon: FaGlobe,
